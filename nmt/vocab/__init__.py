...
def build_vocab(corpus, max_size, min_freq=2):
...
def save_vocab(vocab_dir, vocab):
    vocab['src'].to_file(vocab_dir.file(SRC_VOCAB))
    vocab['tgt'].to_file(vocab_dir.file(TGT_VOCAB))
